...
public class Exercise2Test extends PetDomainForKata
{
    ...
    public void doAnyPeopleHaveCats()
    {
        ...
        Assertions.assertFalse(people.stream().filter(predicate).toList().isEmpty());
    }
    ...
    public void doAllPeopleHavePets()
    {
        ...
        boolean result = people.stream().filter(predicate).toList().isEmpty();
    ...
    public void findMarySmith()
    {
        ...
        Person result = people.stream().filter(person -> person.named("Mary Smith")).findFirst().orElse(null);
    ...
    public void findPetNamedSerpy()
    {
        ...
        List<Pet> petList = people.stream().flatMap(person -> person.getPets().stream()).toList();

        //TODO
        // obtain serpySnake pet from petList
        Pet serpySnake = petList.stream().filter(pet -> pet.getType().equals(PetType.SNAKE)).findFirst().orElse(null);
    ...
    public void getAllPetTypesOfAllPeople()
    {
        ...
        Set<PetType> petTypes = people.stream().map(function)
    ...
    public void getAllPetEmojisOfAllPeople()
    {
        ...
        Set<String> petEmojis = people.stream().map(function).flatMap(stringLongMap -> stringLongMap.keySet().stream()).collect(Collectors.toSet());
    ...
    public void getFirstNamesOfAllPeople()
    {
        ...
        List<String> firstNames = people.stream().map(Person::getFirstName).toList();
    ...
    public void doAnyPeopleHaveCatsRefactor()
    {
        ...
        boolean peopleHaveCatsLambda = !people.stream().filter(person -> person.hasPet(PetType.CAT)).toList().isEmpty();
    ...
    public void doAllPeopleHaveCatsRefactor()
    {
        ...
        boolean peopleHaveCats = people.stream().filter(person -> !person.hasPet(PetType.CAT)).toList().isEmpty();
    ...
    public void getPeopleWithCatsRefactor()
    {
        ...
        List<Person> peopleWithCats = people.stream().filter(person -> person.hasPet(PetType.CAT)).toList();
    ...
    public void getPeopleWithoutCatsRefactor()
    {
        ...
        List<Person> peopleWithoutCats = people.stream().filter(person -> !person.hasPet(PetType.CAT)).toList();
